...
class Tokens : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
    ...
    Q_PROPERTY(const Creomnia::config::AppearanceRounding* rounding READ rounding NOTIFY sourceChanged)
    Q_PROPERTY(const Creomnia::config::AppearanceSpacing* spacing READ spacing NOTIFY sourceChanged)
    Q_PROPERTY(const Creomnia::config::AppearancePadding* padding READ padding NOTIFY sourceChanged)
    Q_PROPERTY(const Creomnia::config::AppearanceFont* font READ font NOTIFY sourceChanged)
    Q_PROPERTY(const Creomnia::config::AppearanceTransparency* transparency READ transparency NOTIFY sourceChanged)
    Q_PROPERTY(const Creomnia::config::SizeTokens* sizes READ sizes NOTIFY sourceChanged)
    Q_PROPERTY(const Creomnia::config::AnimTokens* anim READ anim NOTIFY sourceChanged)
