...
Singleton {
    ...
    function setMode(mode: string): void {
        Quickshell.execDetached(["creomnia", "scheme", "set", "--notify", "-m", mode]);
    }

    function reloadHyprRules(): void {
        const str = "keyword layerrule %1 %2, match:namespace creomnia-drawers";
    ...
    component M3Palette: QtObject {
        property color m3primary_paletteKeyColor: "#6C3CB8"
        property color m3secondary_paletteKeyColor: "#7D70BA"
        property color m3tertiary_paletteKeyColor: "#8377D1"
        property color m3neutral_paletteKeyColor: "#120d1c"
        property color m3neutral_variant_paletteKeyColor: "#541388"
        property color m3background: "#120d1c"
        property color m3onBackground: "#DFB2F4"
        property color m3surface: "#120d1c"
        property color m3surfaceDim: "#120d1c"
        property color m3surfaceBright: "#541388"
        property color m3surfaceContainerLowest: "#0a0710"
        property color m3surfaceContainerLow: "#1a1329"
        property color m3surfaceContainer: "#211833"
        property color m3surfaceContainerHigh: "#2d2145"
        property color m3surfaceContainerHighest: "#392a57"
        property color m3onSurface: "#DFB2F4"
        property color m3surfaceVariant: "#541388"
        property color m3onSurfaceVariant: "#DFB2F4"
        property color m3inverseSurface: "#DFB2F4"
        property color m3inverseOnSurface: "#120d1c"
        property color m3outline: "#8377D1"
        property color m3outlineVariant: "#7D70BA"
        property color m3shadow: "#000000"
        property color m3scrim: "#000000"
        property color m3surfaceTint: "#6C3CB8"
        property color m3primary: "#6C3CB8"
        property color m3onPrimary: "#ffffff"
        property color m3primaryContainer: "#541388"
        property color m3onPrimaryContainer: "#DFB2F4"
        property color m3inversePrimary: "#DFB2F4"
        property color m3secondary: "#7D70BA"
        property color m3onSecondary: "#ffffff"
        property color m3secondaryContainer: "#541388"
        property color m3onSecondaryContainer: "#DFB2F4"
        property color m3tertiary: "#8377D1"
        property color m3onTertiary: "#ffffff"
        property color m3tertiaryContainer: "#541388"
        property color m3onTertiaryContainer: "#DFB2F4"
        ...
        property color m3primaryFixed: "#DFB2F4"
        property color m3primaryFixedDim: "#6C3CB8"
        property color m3onPrimaryFixed: "#120d1c"
        property color m3onPrimaryFixedVariant: "#541388"
        property color m3secondaryFixed: "#DFB2F4"
        property color m3secondaryFixedDim: "#7D70BA"
        property color m3onSecondaryFixed: "#120d1c"
        property color m3onSecondaryFixedVariant: "#541388"
        property color m3tertiaryFixed: "#DFB2F4"
        property color m3tertiaryFixedDim: "#8377D1"
        property color m3onTertiaryFixed: "#120d1c"
        property color m3onTertiaryFixedVariant: "#541388"
